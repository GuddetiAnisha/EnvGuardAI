...
st.title("EnvGuardAI")
st.caption("AI-assisted data-quality validation and readiness orchestration for integration test environments.")
...
with c2:
    if st.button("Repair", use_container_width=True):
        ...
        st.session_state["result"] = {"mode": "repair", "data": {"repaired": repaired, "actions": actions}}
